...
void I2C_Read(uint8_t ADDR, uint8_t *i2cBif, uint8_t NofData)
{
	...
	I2C_MasterSendData(i2cHandler, MPUADDR, i2cBuf, 1);

	I2C_MasterReceiveData(i2cHandler, MPUADDR,i2cBif,NofData);
}
...
void I2C_Write8(uint8_t ADDR, uint8_t data)
{
	...
	I2C_MasterSendData(i2cHandler, MPUADDR, i2cData, 2);
...
void MPU6050_Accel_Cali(float x_min, float x_max, float y_min, float y_max, float z_min, float z_max)
{
	//1* X-Axis calibrate
