...
int main(void)
{
  ...
  osThreadDef(Tarea1, task1_function, osPriorityNormal, 0, 128);
  Tarea1Handle = osThreadCreate(osThread(Tarea1), NULL);

  /* definition and creation of Tarea2 */
  osThreadDef(Tarea2, task2_function, osPriorityAboveNormal, 0, 128);
...
void task2_function(void const * argument)
{
  ...
  for(;;)
  {
	  len = sprintf((char*)txt, "TAREA 2 EJECUTANDOSE\r\n");
